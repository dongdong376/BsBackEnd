...
// @EnableWebMvc
@EnableSwagger2
@ComponentScan(basePackages = {"com.jca.weixinsmallprocess.controller.*.*"})//扫描API位置
...
public class SwaggerConfig extends WebMvcConfigurationSupport {
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("AdminloginAPI").termsOfServiceUrl("http://localhost:8081/jca-adminlogin")
