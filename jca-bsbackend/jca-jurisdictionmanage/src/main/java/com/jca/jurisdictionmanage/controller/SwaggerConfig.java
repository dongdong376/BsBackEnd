package com.jca.jurisdictionmanage.controller;
...
// @EnableWebMvc
@EnableSwagger2
@ComponentScan(basePackages = {"com.jca.jurisdictionmanage.controller"})//扫描API位置
...
public class SwaggerConfig extends WebMvcConfigurationSupport {
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("test模块API").termsOfServiceUrl("http://localhost:8080/jca-peoplemanage")
