package com.jca.datacommon.swagger;
...
// @EnableWebMvc
@EnableSwagger2
@ComponentScan(basePackages = {"com.jca.*.controller.*.*"})//扫描API位置
...
public class SwaggerConfig extends WebMvcConfigurationSupport {
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("test模块API").termsOfServiceUrl("http://localhost:8080/jca-systemset")
