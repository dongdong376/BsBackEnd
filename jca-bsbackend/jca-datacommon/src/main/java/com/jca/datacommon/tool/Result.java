...
public final class Result implements Serializable {
    ...
    public static Result exist(String msg) {
        return of(ResultEnum.EXIST,msg);
    }
     ...
     * @return  Result对象
     */
    public Result withJsonData(Object data) {
        this.jsonData = data;
        return this;
    }
     ...
     * @return  Result对象
     */
    public Result withJsonSum(Object data) {
        this.jsonSum = data;
        return this;
    }
